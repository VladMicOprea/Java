...
public class HelloApplication extends Application {
    ...
    public void start(Stage primaryStage) throws IOException {
        ...
        repo.Repository<String, Utilizator> utilizatorRepository = new UtilizatorDBRepository("jdbc:postgresql://localhost:5432/retea","postgres","Steaua1986");
        repo.Repository<String, Prietenie> prietenieRepository = new PrietenieDBRepository("jdbc:postgresql://localhost:5432/retea","postgres","Steaua1986");
